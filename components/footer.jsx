    ...
    <footer className="site-footer premium-footer">
      <div className="container">
        <div className="footer-intro">
          ...
          <p>Prices, stock, products and checkout stay connected to your WordPress store so the storefront remains easy to manage.</p>
        </div>
        <div className="footer-grid">
          <div className="footer-brand-column">
            <h3>Meraki Artencial Store</h3>
            <p>Resin art supplies, dried flowers, bezels, handmade jewellery, bags, phone cases and creator essentials from Udaipur.</p>
            <div className="footer-socials"><a href="https://instagram.com/merakiartencialstore" target="_blank" rel="noreferrer"><Instagram size={17} /> Instagram</a><a href="https://wa.me/917426915251" target="_blank" rel="noreferrer"><MessageCircle size={17} /> WhatsApp</a></div>
          </div>
