...
add_action( 'wp_head', function () {
	...
	echo '<style>body.woocommerce-checkout .elementor-location-header .elementor-widget-testimonial-carousel{display:none!important}</style>';
...
add_action( 'wp_head', function () {
	...
	echo '<style id="meraki-shopify-checkout-css">body.woocommerce-checkout{background:#f7f4ef!important;color:#171412;font-family:Arial,Helvetica,sans-serif;font-weight:400}body.woocommerce-checkout .site-main,body.woocommerce-checkout #content{background:#f7f4ef}body.woocommerce-checkout h1,body.woocommerce-checkout h2,body.woocommerce-checkout h3{font-weight:600!important;letter-spacing:0;color:#171412}body.woocommerce-checkout form.checkout{max-width:1180px;margin:30px auto 70px!important;padding:0 18px;display:grid!important;grid-template-columns:minmax(0,1fr) minmax(360px,.58fr)!important;gap:44px;align-items:start}body.woocommerce-checkout #customer_details,body.woocommerce-checkout #order_review_heading,body.woocommerce-checkout #order_review{float:none!important;width:auto!important}body.woocommerce-checkout #customer_details{display:block;background:#fff;border:1px solid #ded6c9;border-radius:8px;padding:26px;box-shadow:0 18px 48px rgba(28,23,18,.06)}body.woocommerce-checkout #customer_details .col-1,body.woocommerce-checkout #customer_details .col-2{float:none;width:100%}body.woocommerce-checkout #customer_details .col-2{margin-top:22px;padding-top:22px;border-top:1px solid #ded6c9}body.woocommerce-checkout .form-row label{font-size:12px;font-weight:600;text-transform:uppercase;color:#514b45;margin-bottom:7px}body.woocommerce-checkout .form-row input.input-text,body.woocommerce-checkout .form-row textarea,body.woocommerce-checkout .form-row select,body.woocommerce-checkout .select2-container .select2-selection{min-height:48px;border:1px solid #d9d0c3!important;border-radius:6px!important;background:#fff!important;color:#171412;padding:10px 12px;box-shadow:none!important}body.woocommerce-checkout .form-row input.input-text:focus,body.woocommerce-checkout .form-row textarea:focus{border-color:#171412!important;outline:0;box-shadow:0 0 0 3px rgba(23,20,18,.08)!important}body.woocommerce-checkout #order_review_heading{max-width:1180px;margin:24px auto 0!important;padding:0 18px;font-size:13px;text-transform:uppercase;color:#a17424}body.woocommerce-checkout #order_review{background:#fbf8f4!important;border:1px solid #ded6c9!important;border-radius:8px!important;padding:24px!important;box-shadow:0 18px 48px rgba(28,23,18,.06);position:sticky;top:110px}body.woocommerce-checkout #order_review table.shop_table{border:0;margin:0 0 18px;border-collapse:collapse}body.woocommerce-checkout #order_review table.shop_table th,body.woocommerce-checkout #order_review table.shop_table td{border:0;border-bottom:1px solid #ded6c9;padding:13px 0;font-size:13px}body.woocommerce-checkout #order_review table.shop_table tfoot tr:last-child th,body.woocommerce-checkout #order_review table.shop_table tfoot tr:last-child td{font-size:20px;color:#171412;border-bottom:0;padding-top:18px}body.woocommerce-checkout #payment{background:#fff!important;border:1px solid #ded6c9;border-radius:8px;padding:0;margin-top:18px}body.woocommerce-checkout #payment ul.payment_methods{padding:18px;border-bottom:1px solid #ded6c9}body.woocommerce-checkout #payment div.payment_box{background:#f7f4ef;border-radius:6px;color:#514b45}body.woocommerce-checkout #place_order{width:100%;min-height:54px;border:0;border-radius:6px;background:#171412;color:#fff;text-transform:uppercase;font-weight:700;letter-spacing:0;box-shadow:0 14px 30px rgba(23,20,18,.18)}body.woocommerce-checkout #place_order:hover{background:#b83b47}body.woocommerce-checkout .woocommerce-form-coupon-toggle,body.woocommerce-checkout .woocommerce-info{max-width:1180px;margin:16px auto;border-top-color:#a17424;background:#fff;border-radius:6px}@media(max-width:820px){body.woocommerce-checkout form.checkout{display:block!important;margin:20px auto 50px!important}body.woocommerce-checkout #customer_details{padding:18px}body.woocommerce-checkout #order_review{position:static;margin-top:22px;padding:18px!important}}</style>';
}, 20 );
